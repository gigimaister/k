...
namespace hashtil
{
    ...
    public class New_Magash : AppCompatActivity
    {
        SfDataGrid dataGrid;
        LinearLayout layout;
        Button button;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            GridTextColumn zan = new GridTextColumn();
            zan.MappingName = "Zan";
            //zan.Width = 100;
        ...
        private async void getData()
        {
            ...
            var orderInfo = await url.GetCompanyAsync("newpassportsjson.php");
